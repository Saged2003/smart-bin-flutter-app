  ...
  Future<void> _fetchProfileData() async {
    ...
    try {
      var response = await http.get(
        Uri.parse('http://10.0.2.2:8000/api/profile/?username=$user'),
      );
        ...
        child: Row(
          children: [
            Container(
              ...
              decoration: BoxDecoration(color: b, borderRadius: BorderRadius.circular(10)),
              child: Icon(i, color: isLogout ? c : Colors.grey.shade600, size: 22),
            ),
